...
class DashboardsGatewayRoutingTest {
  ...
  @Test
  void routesNodeInfoLookupsToAstra() {
    assertEquals(Upstream.ASTRA, ROUTING.selectUpstream("/_nodes/astra-query"));
    assertEquals(Upstream.ASTRA, ROUTING.selectUpstream("/_nodes/astra-query/jvm"));
  }
