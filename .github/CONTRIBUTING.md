...
-  If you find a bug, please search for it in the [Issues](https://github.com/kaldb/kaldb/issues), and if it isn't already tracked,
...
### New Features :bulb:
-  If you'd like to add new functionality to this project, describe the problem you want to solve in a [new Issue](https://github.com/kaldb/kaldb/issues/new).
...
[Interested in knowing more about effective pull requests?](https://slack.engineering/on-empathy-pull-requests-979e4257d158#.awxtvmb2z)
...
6.  :inbox_tray: Open a Pull Request on github.com from your new branch on your fork to `kaldb-main` in this
    repository.
